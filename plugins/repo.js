...
async (conn, mek, m, { from, reply }) => {
    const githubRepoURL = 'https://github.com/botwastapp /GOATCR7-Bot-V1';
...
└──────────────────────┘
> *MADE IN BY PRINCE-SALVATORE🔱*`;

        await conn.sendMessage(from, {
            image: { url: `https://files.catbox.moe/5tv800.jpg ` },
            caption: message,
            contextInfo: { 
